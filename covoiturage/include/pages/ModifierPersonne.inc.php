...
if(empty($_GET["per_num"])){
  ...
  if(empty($_POST["per_nom"])&&empty($_POST["per_prenom"])&&empty($_POST["per_tel"])&&empty($_POST["per_mail"])&&empty($_POST["per_login"])&&empty($_POST["per_pwd"])&&empty($_POST["dep_num"])&&empty($_POST["div_num"])&&empty($_POST["fon_num"])&&empty($_POST["sal_telprof"])){
    ?>
